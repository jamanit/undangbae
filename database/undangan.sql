...
('JB9wvxud7kMfSo1h8GDj5IAH6BAYxEB1Za76PASX', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiUGswekI3Q0JUcVpNSERrSXFRYzBid21aMlNVaXhHZllLQTFORFUzcSI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fX0=', 1730714879),
('vhQTacB4ysK2CPoLxkI8AtDXqFqOVXCbk1vPwEiD', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36 Edg/130.0.0.0', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiTWhNVWZ3V3VmQkVndmY3SzNmblBqbTNJQUU4SWZUd2gwTU1kb1ZCUiI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fX0=', 1730714824);
...
(2, '2024-10-28 05:50:30', '2024-11-03 16:37:12', '6ab45e1a-8902-410b-9e21-ed11f2d62f30', 'UNDANGBAE', '2024-12-31', '10'),
...
--
-- Table structure for table `tb_invitation_statuses`
--

CREATE TABLE `tb_invitation_statuses` (
  `id` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `uuid` char(36) NOT NULL,
...
--
-- Dumping data for table `tb_invitation_statuses`
--

INSERT INTO `tb_invitation_statuses` (`id`, `created_at`, `updated_at`, `uuid`, `invitation_status_name`, `description_status`) VALUES
...
(25, '2024-10-29 09:21:14', '2024-10-29 09:24:10', 'fbe52d7d-1c66-4e84-9e2e-2b2681ef4981', 'Hubungi Kami', 'contacts/show-contact-us', 'fas fa-phone');
...
(25, '2024-11-01 05:39:44', '2024-11-01 05:39:44', 'ab0b59c6-79e5-4141-b263-f9f7a3eb5153', 'Invitation Status', 'invitation-statuses', NULL, 3);
...
(1, '2024-10-22 05:50:57', '2024-10-30 03:05:37', '9e487f36-b2cf-4d0e-9f6b-4affa8c1b8aa', 'template/soOMEP1ALjrRRcfHzyzyg36OUmfDenEKmTc3lrkF.jpg', '/invitation-templates/jm-calm/dist/calm-pink.html', 'calm-pink', 'Calm Pink', '100000', '50', 'calm-template', 1, 'Yes', '50000'),
(2, '2024-10-22 05:52:54', '2024-10-30 03:05:25', '9ab0ea3f-b7ce-4800-91d3-3835b84eb2e6', 'template/ZCczungGOnyPV7fe1JkN329nhjDFJBymUnCcQT5O.jpg', '/invitation-templates/jm-calm/dist/calm-blue.html', 'calm-blue', 'Calm Blue', '100000', '50', 'calm-template', 1, 'Yes', '50000'),
(3, '2024-10-22 05:53:36', '2024-10-30 03:05:11', 'e664fea4-15bf-45a7-b933-c93cffb8e5eb', 'template/DtCJOUO4wjVKED8JPA8lH7bFeFuYyjNjz0FWAQkK.jpg', '/invitation-templates/jm-calm/dist/calm-green.html', 'calm-green', 'Calm Green', '100000', '50', 'calm-template', 1, 'Yes', '50000'),
(4, '2024-10-22 05:55:23', '2024-10-30 03:04:59', 'cc472470-632b-4dea-ada2-79b0b96ea05a', 'template/mReRbSX736zmz2qVVqxoHnDRGHzmhz5lPMdew2Vi.jpg', '/invitation-templates/jm-calm/dist/calm-red.html', 'calm-red', 'Calm Red', '100000', '50', 'calm-template', 1, 'Yes', '50000'),
(5, '2024-10-22 05:56:26', '2024-10-30 03:04:40', 'e76f6fe5-6cb3-4f96-95b0-bfd5edf74f41', 'template/evvTrCdsrCF2Lnv1erizx75EKhwMo3IGP0EndF4o.jpg', '/invitation-templates/jm-sideright/dist/sideright-golden-brown.html', 'sideright-golden-brown', 'Sideright Golden Brown', '100000', '50', 'sideright-template', 1, 'Yes', '50000');
...
(6, NULL, 'andiprayitno0698@gmail.com', '2024-11-04 09:46:26', '$2y$12$W4xMTezLXtHafu7swywFvORscJ2Ybyiqb0MCJrBw2TsMzRxbi/H8K', NULL, '2024-11-04 09:44:05', '2024-11-04 09:46:26', '739199b8-0e6e-4fa1-b095-fdab94735c28', 'Andip Payitno', 'Andi', 4);
...
--
-- Indexes for table `tb_invitation_statuses`
--
ALTER TABLE `tb_invitation_statuses`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uuid` (`uuid`) USING BTREE;
...
--
-- AUTO_INCREMENT for table `tb_invitation_statuses`
--
ALTER TABLE `tb_invitation_statuses`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
