...
class C_floral_template extends Controller
{
    ...
    public function edit(Request $request, string $invitation_uuid)
    {
        ...
        return view('invitation.floral-template.V-floral-template', compact('menus', 'invitation', 'gift_types'));
    }
        ...
        try {
            ...
            if ($uuid) {
                ...
                if ($request->hasFile('bride_photo')) {
                    ...
                    $data['bride_photo'] = $request->file('bride_photo')->store('wedding-couple', 'public');
                }
                if ($request->hasFile('groom_photo')) {
                    if ($wedding_couple->groom_photo) {
                        Storage::disk('public')->delete($wedding_couple->groom_photo);
                    }
                    $data['groom_photo'] = $request->file('groom_photo')->store('wedding-couple', 'public');
                }
            ...
            return redirect()->route('invitations.floral-template.edit', $request->invitation_uuid .  $section_parameter)->with('success' . $section_parameter, $message);
    ...
    public function action_gallery(Request $request, string $uuid = null)
    {
        ...
        try {
            ...
            if ($uuid) {
                ...
                if ($uploadedCount >= 10) {
                    return redirect()->route('invitations.floral-template.edit', $request->invitation_uuid . $section_parameter)
