                                            ...
                                            @foreach ($menu_firsts as $menu_first)
                                                <tr>
                                                    <td class="width-1 text-nowrap">
                                                        <a href="#" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#formModal-1" data-id="{{ $menu_first->uuid }}" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                        <a href="#" class="btn btn-danger btn-sm text-white" data-toggle="modal" data-target="#deleteModal" data-id="{{ $menu_first->uuid }}" data-type="1" data-toggle="tooltip" data-placement="top" title="Delete">
