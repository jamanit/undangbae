        ...
        $(document).ready(function() {
            $('#deleteModal').on('show.bs.modal', function(event) {
                ...
                if (itemType == 1) {
                    ...
                    form.attr('action', '/menu_firsts/' + itemId);
                } else {
                    modaTitle.text('Delete Second Menu');
                    form.attr('action', '/menu_seconds/' + itemId);
                }
            });
