                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <x-input_file type="file" name="auth_background" :value="$setting->auth_background" label="Auth Background" />
                                            </div>
                                            <div class="mb-3">
                                                <x-input_file type="file" name="home_cover_image" :value="$setting->home_cover_image" label="Home Cover Image" />
                                            </div>
                                            <div class="mb-3">
