    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="modalForm" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <x-input type="text" name="role_name" label="Role Name" placeholder="Enter Role Name" />
                    </div>
                    <div class="mb-3">
                        <label>Button Access:</label><br>
                        <div>
                            <input type="radio" name="button_access" id="button_access_no" value="0">
                            <label for="button_access_no">No</label>
                        </div>
                        <div>
                            <input type="radio" name="button_access" id="button_access_yes" value="1">
                            <label for="button_access_yes">Yes</label>
                        </div>
                    </div>
                </div>
                <div class="modal-footer bg-whitesmoke br">
