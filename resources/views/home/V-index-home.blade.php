...
@section('content')
    ...
    <section id="services" class="relative w-full pt-16 bg-gray-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
            <h2 class="text-3xl text-center font-bold text-purple-400 mb-4">Layanan</h2>
    ...
    <section id="template" class="relative w-full pt-16 bg-white">
        <div class="md:w-3/4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
            <h2 class="text-3xl text-center font-bold text-purple-400 mb-8">Templat</h2>
    ...
    <section id="about" class="relative w-full pt-16 bg-gray-300">
        <div class="md:w-3/4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
            <h2 class="text-3xl text-center font-bold text-purple-400 mb-4">Tentang Kami</h2>
    ...
    <section id="contact" class="relative w-full py-16 bg-white">
        <div class="md:w-3/4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-hidden">
            <h2 class="text-3xl text-center font-bold text-purple-400 mb-8">Kontak</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Kolom Kiri: Formulir -->
                <div data-aos="fade-right">
                    <form id="contact-form" onsubmit="sendMessage(event, 'bg-purple-500')">
                        <div class="mb-4">
                            <label for="name" class="mb-2 block text-left text-sm font-semibold text-gray-800">Nama</label>
                            <input type="text" name="name" id="name" placeholder="Masukkan Nama" class="w-full rounded-lg border border-purple-400 p-3 focus:outline-none focus:ring-2 focus:ring-purple-400" />
                        </div>
                        <div class="mb-4">
                            <label for="email" class="mb-2 block text-left text-sm font-semibold text-gray-800">Email</label>
                            <input type="email" name="email" id="email" placeholder="Masukkan Email" class="w-full rounded-lg border border-purple-400 p-3 focus:outline-none focus:ring-2 focus:ring-purple-400" />
                        </div>
                        <div class="mb-4">
                            <label for="message" class="mb-2 block text-left text-sm font-semibold text-gray-800">Pesan</label>
                            <textarea name="message" id="message" placeholder="Masukkan Pesan" class="w-full rounded-lg border border-purple-400 p-3 focus:outline-none focus:ring-2 focus:ring-purple-400" rows="2"></textarea>
                        </div>
                ...
                <div class="flex flex-col items-start" data-aos="fade-left">
                    ...
                    <div class="flex space-x-4 mb-4">
                        @foreach ($contacts as $item)
                            <a href="{{ $item->url }}" class="text-gray-800 hover:text-purple-400 text-2xl" title="{{ $item->platform }}" target="_blank">
                                <i class="{{ $item->icon }}"></i>
                            </a>
                        @endforeach
                    </div>
