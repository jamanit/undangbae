...
@section('content')
    ...
    @include('invitation-status.V-modal-invitation-status')
@endsection
    ...
    <script>
        $(document).ready(function() {
            $("#table-serverside").DataTable({
                ...
                serverSide: true,
                order: [],
                ajax: "{{ route('invitation-statuses.index') }}",
                columns: [{
                        data: 'id',
                        name: 'id'
                    }, {
            ...
            $('#deleteModal').on('show.bs.modal', function(event) {
                ...
                form.attr('action', '/invitation-statuses/' + itemId);
            });
            ...
            $('#formModal').on('show.bs.modal', function(event) {
                ...
                if (typeof itemId === 'undefined') {
                    ...
                    btnSubmit.text('Save');
                    form.attr('action', '/invitation-statuses');
                    ...
                    $.ajax({
                        url: '/invitation-statuses/' + itemId + '/edit',
                        method: 'GET',
