...
@section('content')
    ...
    <div class="flex h-screen w-full items-center justify-center bg-primary-pink-400 font-worksans">
        ...
        <div class="fixed z-0 h-screen w-full lg:w-1/3">
            <img src="{{ asset('/') }}invitation_templates/storage/cover/pink-cover-image.jpg" class="inset-0 z-0 h-full w-full object-cover" alt="Cover Image" />
        ...
        <footer id="bottom-footer" class="fixed bottom-0 z-40 flex hidden w-full flex-col items-center px-2">
            ...
            <div id="menu" class="flex w-full overflow-x-auto rounded-lg bg-gray-800 py-2 text-white lg:w-1/3" data-aos="fade-up" data-aos-offset="50" data-aos-duration="500">
                <div class="flex space-x-4 px-4">
                    ...
                    <div class="menu-item flex w-20 cursor-pointer flex-col items-center rounded-lg transition duration-300 hover:bg-gray-700 hover:text-pink-400" onclick="setActive(this, 'jaman-section', 'text-pink-400')">
        ...
        <div class="relative z-20 h-full w-full lg:w-1/3">
            ...
            <section id="cover-section" class="relative h-auto w-full overflow-hidden">
                <div class="relative w-full">
                    <img src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/image/pink-flower-1.png" class="absolute left-0 top-0 z-20 w-2/6" data-aos="fade-right" />
                    <img src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/image/pink-flower-2.png" class="absolute right-0 top-0 z-20 w-2/6" data-aos="fade-left" />
                </div>
                        ...
                        <div class="max-h-[70vh] overflow-y-auto px-4 pb-8 pt-4">
                            ...
                            @foreach ($bankAccounts as $item)
                                <div class="relative mb-4">
                                    <img src="{{ asset('/') }}invitation_templates/jm-calm/dist/assets/image/card-money.jpg" class="h-40 w-full rounded-3xl border-2 border-pink-400 object-cover" />
                ...
                <div class="relative z-30 mx-4 my-4 mb-28 flex h-screen flex-col items-center justify-center">
                    ...
                    @if ($business_profile)
                        <div class="text-center text-white" data-aos="zoom-in">
                            <p class="text-base">
                                Copyright &copy; {{ date('Y', strtotime($business_profile->business_founding_date)) }} <span class="font-semibold text-pink-400">{{ $business_profile->business_name }}</span>. All rights reserved.
                            </p>
                        </div>
                    @endif
                </div>
