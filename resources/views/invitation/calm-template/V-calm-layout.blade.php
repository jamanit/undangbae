...
<head>
    ...
    <link href="{{ asset('/') }}invitation-templates/jm-calm/dist/assets/fortawesome/fontawesome-free/css/all.css" rel="stylesheet" />
    <link href="{{ asset('/') }}invitation-templates/jm-calm/dist/assets/aos/dist/aos.css" rel="stylesheet" />
    <link href="{{ asset('/') }}invitation-templates/jm-calm/dist/assets/fancyapps/ui/dist/fancybox/fancybox.css" rel="stylesheet" />
    <script src="{{ asset('/') }}invitation-templates/jm-calm/dist/assets/sweetalert2/dist/sweetalert2.all.min.js"></script>
...
<body class="flex h-screen w-full items-center justify-center font-worksans @stack('body-classes')">
    ...
    <script>
        ...
        function sendMessage(event, color) {
            ...
            $.ajax({
                url: '/invitations/calm-template/send-message', // Ganti dengan endpoint yang sesuai
                method: 'POST',
        ...
        function fetchLatestMessages() {
            ...
            $.ajax({
                url: '/invitations/calm-template/get-message/' + invitation_id,
                method: 'GET',
                success: function(data) {
