            ...
            <section id="cover-section" class="relative h-auto w-full overflow-hidden">
                ...
                <div class="relative z-30 mx-4 my-4 flex h-screen flex-col items-center justify-center">
                    <div class="text-center" data-aos="fade-down">
                        ...
                        <p class="mb-16 font-sacramento text-4xl font-semibold text-green-400">{{ $invitation->wedding_couple ? $invitation->wedding_couple->bride_nickname . ' & ' . $invitation->wedding_couple->groom_nickname : 'Wanita & Pria' }}</p>
                    </div>
                ...
                <div class="relative z-30 mx-4 my-4 mb-28 flex h-screen flex-col items-center justify-center text-center">
                    @if ($invitation->closing)
                        ...
                        <div data-aos="fade-up">
                            ...
                            <p class="pb-32 font-sacramento text-4xl font-semibold text-green-400">{{ $invitation->wedding_couple ? $invitation->wedding_couple->bride_nickname . ' & ' . $invitation->wedding_couple->groom_nickname : 'Wanita & Pria' }}</p>
                        </div>
                    @endif
                </div>
            </section>
