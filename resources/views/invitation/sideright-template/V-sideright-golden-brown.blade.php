    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div id="content" class="ml-auto h-screen w-full overflow-y-hidden sm:w-1/2 lg:w-1/3">
            ...
            <section class="relative h-screen w-full">
                <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden_brown/main-image.jpg" class="absolute h-full w-full object-cover" alt="Background Image" />
            ...
            @if ($invitation->wedding_couple)
                <section class="relative h-full w-full bg-white">
                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden_brown/flower-1.png" class="absolute top-0 z-10 w-full object-cover" />
                    ...
                    <div class="relative">
                        <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden_brown/flower-4.png" class="absolute bottom-0 z-10 w-full object-cover" />
                    </div>
                </section>
            @endif
            ...
            @if ($invitation->event)
                <section class="relative h-full w-full bg-gradient-to-l from-black to-gray-800">
                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden_brown/flower-2.png" class="absolute w-full object-cover" />
                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden_brown/layer-1a.png" class="relative z-10 w-full object-cover px-2 pt-2" />

                    <div class="relative z-10 text-primary-golden-brown-400 overflow-hidden">
                        <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden_brown/layer-1b.png" class="absolute h-full w-full px-2" />
                    ...
                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden_brown/layer-1c.png" class="relative z-10 w-full object-cover px-2 pb-2" />
                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden_brown/flower-3.png" class="absolute bottom-0 w-full object-cover" />
                </section>
            @endif
                        ...
                        <div class="max-h-[70vh] overflow-y-auto px-4 pb-8 pt-4">
                            ...
                            @foreach ($bankAccounts as $item)
                                <div class="relative mb-4">
                                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden_brown/card-money.jpg" class="h-40 w-full rounded-3xl border-2 border-primary-golden-brown-400 object-cover" />
            ...
            @if ($invitation->closing)
                <section class="relative h-full w-full bg-gradient-to-l from-black to-gray-800">
                    ...
                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden_brown/flower-5.png" class="absolute bottom-0 z-10 w-full object-cover" />
                </section>
            @endif
