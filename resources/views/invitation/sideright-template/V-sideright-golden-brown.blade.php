    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div id="content" class="ml-auto h-screen w-full overflow-y-hidden sm:w-1/2 lg:w-1/3">
            ...
            <section class="relative h-screen w-full">
                <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden-brown/main-image.jpg" class="absolute h-full w-full object-cover" alt="Background Image" />
            ...
            @if ($invitation->wedding_couple)
                <section class="relative h-full w-full bg-white">
                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden-brown/flower-1.png" class="absolute top-0 z-10 w-full object-cover" />
                    ...
                    <div class="relative">
                        <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden-brown/flower-4.png" class="absolute bottom-0 z-10 w-full object-cover" />
                    </div>
                </section>
            @endif
            ...
            @if ($invitation->event)
                <section class="relative h-full w-full bg-gradient-to-l from-black to-gray-800">
                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden-brown/flower-2.png" class="absolute w-full object-cover" />
                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden-brown/layer-1a.png" class="relative z-10 w-full object-cover px-2 pt-2" />

                    <div class="relative z-10 text-primary-golden-brown-400 overflow-hidden">
                        <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden-brown/layer-1b.png" class="absolute h-full w-full px-2" />
                    ...
                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden-brown/layer-1c.png" class="relative z-10 w-full object-cover px-2 pb-2" />
                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden-brown/flower-3.png" class="absolute bottom-0 w-full object-cover" />
                </section>
            @endif
                        ...
                        <div class="max-h-[70vh] overflow-y-auto px-4 pb-8 pt-4">
                            ...
                            @foreach ($bankAccounts as $item)
                                <div class="relative mb-4">
                                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden-brown/card-money.jpg" class="h-40 w-full rounded-3xl border-2 border-primary-golden-brown-400 object-cover" />
                                    ...
                                    <div class="flex rounded-3xl border-2 border-primary-golden-brown-400 p-2">
                                        ...
                                        <div class="flex flex-col justify-center">
                                            ...
                                            <p class="px-1 py-1 text-base">
                                                ...
                                                <i id="copy-icon" class="fa-regular fa-copy cursor-pointer text-2xl hover:text-primary-golden-brown-400" onclick="copyToClipboard('bg-primary-golden-brown-500', '{{ $item->recipient_name . ' / ' . $item->recipient_phone_number . ' / ' . $item->recipient_address }}')""></i>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="px-4 py-8">
                    ...
                    <div data-aos="flip-left">
                        <div class="mx-auto max-w-4xl rounded-3xl border-2 border-primary-golden-brown-400 bg-white p-6 shadow-lg">
                            ...
                            <div id="messages" data-color="text-primary-golden-brown-500" class="mt-8 max-h-96 overflow-y-auto space-y-4 rounded-lg border border-gray-300 p-2">
            ...
            @if ($invitation->closing)
                <section class="relative h-full w-full bg-gradient-to-l from-black to-gray-800">
                    <div data-aos="fade-up">
                        <div class="px-4 pt-8 text-center text-primary-golden-brown-400 relative z-20">
                    ...
                    <img src="{{ asset('/') }}invitation-templates/jm-sideright/dist/assets/image/golden-brown/flower-5.png" class="absolute bottom-0 z-10 w-full object-cover" />
                </section>
            @endif
                    ...
                    <div class="flex flex-col items-center text-white">
                        ...
                        @if ($business_profile)
                            <div class="text-center">
                                <p class="text-sm">
                                    Copyright &copy; {{ date('Y', strtotime($business_profile->brand_founding_date)) }} <span class="font-semibold text-primary-golden-brown-400">{{ $business_profile->brand_name }}</span>. All rights reserved.
                                </p>
                            </div>
                        @endif
                    </div>
