                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            <x-input type="text" name="" label="Kadaluarsa Undangan" :value="$transaction->invitation->expired_date" readonly />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                        ...
                                        <form action="{{ route('invitations.update-percent-discount', $transaction->uuid) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <form id="form_transaction" action="{{ route('invitations.update-transaction', $transaction->uuid) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="mb-3">
                                                        <x-input-file type="file" name="payment_receipt" label="Bukti Pembayaran" :value="$transaction->payment_receipt" image readonly />
                                                    </div>
                                                </form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    ...
                    @foreach ($invitation_status as $item)
                        ...
                        @endphp
                        <form action="{{ url('invitations/update-invitation-status/' . $transaction->invitation_id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('PUT')
