...
@section('content')
    ...
    <div id="bottom-footer" class="z-50 fixed bottom-10 right-0 flex hidden flex-col items-end">
        <div class="flex flex-col w-full justify-end overflow-hidden px-2" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
            <div class="mb-4">
                <button id="toggle-audio" onclick="toggleAudio()" class="rounded-full bg-primary-brown-500 px-4 py-2 text-sm text-white hover:bg-primary-brown-600">
            ...
            <button id="scrollUp" onclick="scrollUp()" class="rounded-full bg-primary-brown-500 px-4 py-2 text-sm text-white hover:bg-primary-brown-600">
    ...
    <div class="z-0 lg:w-1/3 fixed bottom-0 right-0 h-screen w-full">
        <img src="{{ asset('/') }}invitation-templates/jm-floral/dist/assets/image/brown/0.png" class="inset-0 h-full w-full object-cover" alt="Cover Image" />
    </div>
    ...
    <div id="content" class="z-10 relative h-screen overflow-y-hidden lg:w-1/3">
        ...
        <section id="cover-section" class="z-10 relative h-screen w-full overflow-hidden">
            <div class="absolute h-full w-full flex justify-start items-center">
                <img src="{{ asset('/') }}invitation-templates/jm-floral/dist/assets/image/brown/41.png" class="z-10 absolute w-full inset-x-0 top-0" data-aos="fade-right" />
                <img src="{{ asset('/') }}invitation-templates/jm-floral/dist/assets/image/brown/42.png" class="z-20 absolute w-full inset-x-0 top-0" data-aos="fade-left" />

                <img src="{{ asset('/') }}invitation-templates/jm-floral/dist/assets/image/brown/43.png" class="z-20 absolute w-full inset-x-0 bottom-0" data-aos="fade-right" />
                <img src="{{ asset('/') }}invitation-templates/jm-floral/dist/assets/image/brown/44.png" class="z-10 absolute w-full inset-x-0 bottom-0" data-aos="fade-left" />
            </div>

            <div class="z-30 relative h-full w-full flex items-center justify-center flex-col">
                <p class="mb-4 text-base text-primary-brown-400 font-semibold" data-aos="fade-down">{{ $invitation->transaction->template->template_type->template_type_name ?? '' }}</p>

                <div class="flex flex-col items-center justify-center mb-4">
                    <div class="z-40 absolute flex flex-col text-center" data-aos="zoom-in">
                        <p class="font-sacramento text-4xl font-semibold text-primary-brown-400">{{ $invitation->wedding_couple ? $invitation->wedding_couple->bride_nickname : 'Wanita' }}</p>
                        <p class="font-sacramento text-4xl font-semibold text-primary-brown-400">&</p>
                        <p class="font-sacramento text-4xl font-semibold text-primary-brown-400">{{ $invitation->wedding_couple ? $invitation->wedding_couple->groom_nickname : 'Pria' }}</p>
                    </div>
                    <img src="{{ asset('/') }}invitation-templates/jm-floral/dist/assets/image/brown/11.png" class="z-30 w-full h-full" data-aos="zoom-in" />
                </div>

                <div data-aos="fade-up" data-aos-offset="50">
                    <div class="text-center border-2 border-primary-brown-500 rounded-lg p-2 bg-white/75">
                    ...
                    <button onclick="openInvitation()" class="mx-auto mt-6 rounded-full bg-primary-brown-500 px-4 py-2 text-base text-white hover:bg-primary-brown-600">
        ...
        <section id="quote-section" class="z-10 relative min-h-screen w-full overflow-hidden">
            ...
            <div class="z-30 relative min-h-screen w-full px-4 py-8 flex flex-col items-center justify-center">
                <p class="mb-4 mt-6 px-2 text-center font-sacramento text-4xl font-semibold text-primary-brown-400" data-aos="fade-right">
                    Kutipan
                </p>
                <div class="px-2">
                    @if ($invitation->quote)
                        <div class="mb-4 text-base text-primary-brown-400 text-justify" data-aos="fade-right">
        ...
        <section id="wedding-couple-section" class="z-10 relative min-h-screen w-full overflow-hidden">
            ...
            <div class="z-30 px-4 py-8 relative min-h-screen w-full flex flex-col items-center justify-center">
                <p class="mb-4 mt-6 px-2 text-center font-sacramento text-4xl font-semibold text-primary-brown-400" data-aos="fade-down">
                    Mempelai
                </p>
                <div class="px-2">
                    @if ($invitation->wedding_couple)
                        ...
                        <div class="mb-4 flex items-center space-x-4 justify-start" data-aos="fade-right">
                            <img src="{{ Storage::url($invitation->wedding_couple->bride_photo) }}" class="mb-2 h-36 w-28 rounded-b-[30%] rounded-t-[30%] border-4 border-primary-brown-400 object-cover" />
                            <div class="text-left">
                                <p class="font-sacramento text-4xl font-semibold text-primary-brown-400">{{ $invitation->wedding_couple->bride_nickname }}</p>
                        ...
                        <div data-aos="fade-left">
                            ...
                            <div class="mb-4 flex items-center space-x-4 justify-end">
                                <div class="text-right">
                                    <p class="font-sacramento text-4xl font-semibold text-primary-brown-400">{{ $invitation->wedding_couple->groom_nickname }}</p>
                                ...
                                <img src="{{ Storage::url($invitation->wedding_couple->groom_photo) }}" class="mb-2 h-36 w-28 rounded-b-[30%] rounded-t-[30%] border-4 border-primary-brown-400 object-cover" />
                            </div>
                        </div>
                    @endif
                </div>
            ...
            <div class="z-30 relative px-4 py-8 min-h-screen w-full flex flex-col items-center justify-center">
                ...
                @if ($invitation->event)
                    ...
                    <div id="countdown" data-countdown="{{ $nearest_date }}" class="mb-4 flex justify-center gap-2" data-aos="fade-left">
                        <div class="bg-white/75 border-2 border-primary-brown-500 rounded-lg p-2 shadow-lg w-15 text-center">
                            <span id="days" class="text-xl font-bold text-primary-brown-500">00</span>
                            <div class="text-sm text-gray-600">Hari</div>
                        </div>
                        <div class="bg-white/75 border-2 border-primary-brown-500 rounded-lg p-2 shadow-lg w-15 text-center">
                            <span id="hours" class="text-xl font-bold text-primary-brown-500">00</span>
                            <div class="text-sm text-gray-600">Jam</div>
                        </div>
                        <div class="bg-white/75 border-2 border-primary-brown-500 rounded-lg p-2 shadow-lg w-15 text-center">
                            <span id="minutes" class="text-xl font-bold text-primary-brown-500">00</span>
                            <div class="text-sm text-gray-600">Menit</div>
                        </div>
                        <div class="bg-white/75 border-2 border-primary-brown-500 rounded-lg p-2 shadow-lg w-15 text-center">
                            <span id="seconds" class="text-xl font-bold text-primary-brown-500">00</span>
                            <div class="text-sm text-gray-600">Detik</div>
                        </div>
                    </div>

                    @if ($invitation->event && !empty(trim($invitation->event->event_date_1)))
                        <div class="mb-4 w-full rounded-lg border-2 border-primary-brown-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-right">
                            <p class="mb-2 font-sacramento text-4xl font-semibold text-primary-brown-400">{{ $invitation->event->event_type_1 }}</p>
                            ...
                            <a href="{{ $invitation->event->map_url_1 }}" target="_blank">
                                <button class="mx-auto mt-1 rounded-full bg-primary-brown-500 px-4 py-2 text-sm text-white hover:bg-primary-brown-600">
                    ...
                    @if ($invitation->event && !empty(trim($invitation->event->event_date_2)))
                        <div class="mb-4 w-full rounded-lg border-2 border-primary-brown-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-left">
                            <p class="mb-2 font-sacramento text-4xl font-semibold text-primary-brown-400">{{ $invitation->event->event_type_2 }}</p>
                    ...
                    @if ($invitation->event && !empty(trim($invitation->event->event_date_3)))
                        <div class="mb-4 w-full rounded-lg border-2 border-primary-brown-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-right">
                            <p class="mb-2 font-sacramento text-4xl font-semibold text-primary-brown-400">{{ $invitation->event->event_type_3 }}</p>
        ...
        <section id="gallery-streaming-section" class="z-10 relative min-h-screen w-full overflow-hidden">
            ...
            <div class="z-30 relative px-4 py-8 min-h-screen w-full flex flex-col items-center justify-center">
                <p class="mb-4 mt-6 px-2 text-center font-sacramento text-4xl font-semibold text-primary-brown-400" data-aos="flip-left">
                    Galeri
                </p>
        ...
        <section id="love-story-section" class="z-10 relative min-h-screen w-full overflow-hidden">
            ...
            <div class="z-30 relative px-4 py-8 min-h-screen w-full flex flex-col items-center justify-center">
                <p class="mb-4 mt-6 px-2 text-center font-sacramento text-4xl font-semibold text-primary-brown-400" data-aos="fade-up">
                    Kisah Cinta
                </p>

                @if (!$invitation->love_stories->isEmpty())
                    @foreach ($invitation->love_stories as $index => $item)
                        <div class="mb-4 w-full rounded-lg border-2 border-primary-brown-400 bg-white/75 p-4 text-center text-gray-600 shadow-lg" data-aos="fade-up">
                            <p class="mb-4 text-center font-sacramento text-2xl font-semibold text-primary-brown-400">
                                {{ $item->title }}
                            </p>
        ...
        <section id="message-gift-section" class="z-10 relative min-h-screen w-full overflow-hidden">
            ...
            <div class="z-30 relative px-4 py-8 min-h-screen w-full flex flex-col items-center justify-center">
                <p class="mb-4 mt-6 px-2 text-center font-sacramento text-4xl font-semibold text-primary-brown-400" data-aos="zoom-in">
                    Ucapan
                </p>
                <div class="mb-4 w-full rounded-lg border-2 border-primary-brown-400 bg-white/75 p-4 shadow-lg" data-aos="zoom-in">
                    <form id="message-form" onsubmit="sendMessage(event, 'bg-primary-brown-500')">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" placeholder="Masukkan nama Anda" class="w-full rounded-lg border border-primary-brown-400 p-3 focus:outline-none focus:ring-2 focus:ring-primary-brown-400" />
                        </div>
                        <div class="mb-4">
                            <label for="message" class="mb-2 block text-left text-sm font-semibold text-gray-600">Pesan</label>
                            <textarea name="message" id="message" placeholder="Berikan ucapan serta doa restu Anda" class="w-full rounded-lg border border-primary-brown-400 p-3 focus:outline-none focus:ring-2 focus:ring-primary-brown-400" rows="2"></textarea>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4" id="guest_input" style="display: none">
                            ...
                            <input type="number" name="guest_totals" id="guest_totals" placeholder="Masukkan jumlah tamu (orang)" class="w-full rounded-lg border border-primary-brown-400 p-3 focus:outline-none focus:ring-2 focus:ring-primary-brown-400" />
                        </div>
                        <button type="submit" class="mt-4 w-full rounded-full bg-primary-brown-500 p-2 text-base text-white hover:bg-primary-brown-600">
                ...
                @if (!$invitation->gifts->isEmpty())
                    <div class="mb-4 w-full rounded-lg border-2 border-primary-brown-400 bg-white/75 p-4 shadow-lg" data-aos="zoom-in">
                        ...
                        <button id="open-modal" class="w-full rounded-full bg-primary-brown-500 p-2 text-base text-white hover:bg-primary-brown-600">
        ...
        @if (!$invitation->gifts->isEmpty())
            <div id="gift-modal" class="fixed inset-0 z-50 flex hidden justify-center bg-black bg-opacity-50 py-4">
                <div class="relative mx-4 max-h-[80vh] w-full max-w-md overflow-hidden rounded-lg bg-white">
                    <div class="flex p-4">
                        <p class="font-sacramento text-4xl font-semibold text-primary-brown-400">Hadiah</p>
                    ...
                    <div class="max-h-[70vh] overflow-y-auto px-4 pb-8 pt-4">
                        ...
                        @foreach ($bankAccounts as $item)
                            <div class="relative mb-4">
                                <img src="{{ asset('/') }}invitation-templates/jm-floral/dist/assets/image/brown/card-money.jpg" class="h-40 w-full rounded-3xl border-2 border-primary-brown-400 object-cover" />
                                <div class="absolute inset-0 flex flex-col items-start justify-center pl-4">
                                    <p class="px-4 py-1 text-2xl font-semibold text-primary-brown-400">{{ $item->account_name }}</p>
                                    <p class="px-4 py-1 text-2xl">
                                        {{ $item->account_number }}
                                        <i id="copy-icosn" class="fa-regular fa-copy cursor-pointer hover:text-primary-brown-400" onclick="copyToClipboard('bg-primary-brown-500', '{{ $item->account_number }}')"></i>
                                    </p>
                        ...
                        @foreach ($other_gifts as $item)
                            <div class="relative mb-4">
                                <div class="flex rounded-3xl border-2 border-primary-brown-400 p-2">
                                    <div class="flex items-center px-4">
                                        <i class="fas fa-gift text-3xl text-primary-brown-400"></i>
                                    </div>
                                    <div class="flex flex-col justify-center">
                                        ...
                                        <p class="px-1 py-1 text-base">
                                            ...
                                            <i class="fa-regular fa-copy cursor-pointer text-2xl hover:text-primary-brown-400" onclick="copyToClipboard('bg-primary-brown-500', '{{ $item->recipient_name . ' / ' . $item->recipient_phone_number . ' / ' . $item->recipient_address }}')"></i>
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="px-2">
                    @if ($invitation->closing)
                        <div class="mb-4 text-center">
                            <img src="{{ asset('/') }}invitation-templates/jm-floral/dist/assets/image/brown/45.png" class="z-20 w-full inset-x-0 mb-4" data-aos="fade-down" />
                            ...
                            <p class="mb-4 font-sacramento text-4xl font-semibold text-primary-brown-400" data-aos="fade-up">
                                {{ $invitation->wedding_couple ? $invitation->wedding_couple->bride_nickname . ' & ' . $invitation->wedding_couple->groom_nickname : 'Wanita & Pria' }}
                            </p>
                            <img src="{{ asset('/') }}invitation-templates/jm-floral/dist/assets/image/brown/46.png" class="z-20 w-full inset-x-0 mb-4" data-aos="fade-up" />
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="container mx-auto px-4 py-6">
                <div class="flex flex-col items-center text-white">
                    <div class="mb-4 flex space-x-4">
                        <a href="#" class="hover:text-primary-brown-400" title="WhatsApp" target="_blank">
                            <i class="fab fa-whatsapp text-2xl"></i>
                        </a>
                        <a href="#" class="hover:text-primary-brown-400" title="Instagram" target="_blank">
                            <i class="fab fa-instagram text-2xl"></i>
                        </a>
                        <a href="#" class="hover:text-primary-brown-400" title="Website" target="_blank">
                            <i class="fas fa-globe text-2xl"></i>
                        </a>
                    </div>
                    <div class="text-center">
                        <p class="text-sm">
                            Copyright &copy; 2024 <span class="font-semibold text-primary-brown-400">UndangBae</span>.
                            All
                            rights reserved.
                        </p>
                    </div>
