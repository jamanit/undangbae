    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                @endif
                <form action="{{ isset($invitation->wedding_couple) ? route('invitations.floral-template.action-wedding-couple', $invitation->wedding_couple->uuid) : route('invitations.floral-template.action-wedding-couple') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                @endif
                <form action="{{ isset($invitation->quote) ? route('invitations.floral-template.action-quote', $invitation->quote->uuid) : route('invitations.floral-template.action-quote') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                @endif
                <form action="{{ isset($invitation->event) ? route('invitations.floral-template.action-event', $invitation->event->uuid) : route('invitations.floral-template.action-event') }}" method="POST">
                    @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('invitations.floral-template.action-love-story') }}" method="POST">
                            @csrf
                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                            <div class="row">
                                        ...
                                        @foreach ($invitation->love_stories as $item)
                                            <tr>
                                                ...
                                                <td class="text-nowrap width-1">
                                                    <form action="{{ route('invitations.floral-template.action-love-story', $item->uuid) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                                                        <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                ...
                @endif
                <form action="{{ isset($invitation->streaming) ? route('invitations.floral-template.action-streaming', $invitation->streaming->uuid) : route('invitations.floral-template.action-streaming') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('invitations.floral-template.action-gift') }}" method="POST">
                            @csrf
                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                            <div class="row">
                                        ...
                                        @foreach ($invitation->gifts as $item)
                                            @if ($item->gift_type_name === 'Rekening Bank')
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap width-1">
                                                        <form action="{{ route('invitations.floral-template.action-gift', $item->uuid) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                                                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('invitations.floral-template.action-gallery') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                            <div class="row">
                                ...
                                <div class="row">
                                    @foreach ($invitation->galleries as $item)
                                        <div class="col-4 col-sm-3 col-md-2 col-lg-2 position-relative mb-3">
                                            ...
                                            <form action="{{ route('invitations.floral-template.action-gallery', $item->uuid) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                                                <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                ...
                @endif
                <form action="{{ isset($invitation->audio) ? route('invitations.floral-template.action-audio', $invitation->audio->uuid) : route('invitations.floral-template.action-audio') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                @endif
                <form action="{{ isset($invitation->closing) ? route('invitations.floral-template.action-closing', $invitation->closing->uuid) : route('invitations.floral-template.action-closing') }}" method="POST">
                    @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('invitations.floral-template.action-guest') }}" method="POST">
                            @csrf
                            <input type="hidden" name="invitation_id" id="invitation_id" value="{{ $invitation->id }}">
                            <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="{{ $invitation->uuid }}">
                            <div class="row">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#table-serverside-guests").DataTable({
                ...
                order: [],
                ajax: {
                    url: "/invitations/floral-template/edit/" + invitation_uuid,
                    data: {
                        type: 'guests'
                    }
                },
                columns: [{
                    ...
                    "render": function(data, type, row) {
                        ...
                        return `
                            ...
                            <form action="/invitations/floral-template/action-guest/${row.uuid}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
            ...
            $("#table-serverside-messages").DataTable({
                ...
                columns: [{
                    ...
                    "render": function(data, type, row) {
                        return ` 
                            <form action="/invitations/floral-template/action-message/${row.uuid}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <input type="hidden" name="invitation_id" id="invitation_id" value="${invitation_id}">
                                <input type="hidden" name="invitation_uuid" id="invitation_uuid" value="${invitation_uuid}">
