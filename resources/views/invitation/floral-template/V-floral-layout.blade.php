...
<head>
    ...
    <link href="{{ asset('/') }}invitation-templates/jm-floral/dist/assets/fortawesome/fontawesome-free/css/all.css" rel="stylesheet" />
    <link href="{{ asset('/') }}invitation-templates/jm-floral/dist/assets/aos/dist/aos.css" rel="stylesheet" />
    <link href="{{ asset('/') }}invitation-templates/jm-floral/dist/assets/fancyapps/ui/dist/fancybox/fancybox.css" rel="stylesheet" />
    <script src="{{ asset('/') }}invitation-templates/jm-floral/dist/assets/sweetalert2/dist/sweetalert2.all.min.js"></script>
...
<body class="font-worksans flex items-center justify-end @stack('body-classes')">
    ...
    <script>
        ...
        function sendMessage(event, color) {
            ...
            $.ajax({
                url: '/invitations/floral-template/send-message', // Ganti dengan endpoint yang sesuai
                method: 'POST',
        ...
        function fetchLatestMessages() {
            ...
            $.ajax({
                url: '/invitations/floral-template/get-message/' + invitation_id,
                method: 'GET',
                success: function(data) {
