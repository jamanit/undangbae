                        ...
                        <div class="col-6 col-sm-4 col-md-3 col-lg-3">
                            <div class="card position-relative">
                                ...
                                <div class="card-footer p-2 d-flex">
                                    ...
                                    <form id="form_template_{{ $item->id }}" action="{{ route('invitations.store-invitation') }}" method="POST" class="ml-auto">
                                        @csrf
...
@push('scripts')
    <script>
        ...
        $('#load-more-template').on('click', function() {
            $.ajax({
                url: '/invitations/load-more-template',
                type: 'GET',
                data: {
                    offset: offset
                },
                                                ...
                                                <div class="col-6 col-sm-4 col-md-3 col-lg-3">
                                                    <div class="card position-relative">
                                                        ...
                                                        <div class="card-footer p-2 d-flex">
                                                            ...
                                                            <form action="{{ route('invitations.store-invitation') }}" method="POST" class="ml-auto">
                                                                @csrf
                                                                <input type="hidden" name="template_id" id="template_id" value="${item.id}">
